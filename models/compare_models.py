...
def main():
    ...
    table_df = display_df[['model', 'ROC-AUC', 'Brier', 'Log Loss', 'Balanced Accuracy', 'n_features']]
    if HAS_TABULATE:
    ...
    print(f"Lowest Brier Score:         {comparison_df.loc[comparison_df['brier_mean'].idxmin(), 'model']} "
